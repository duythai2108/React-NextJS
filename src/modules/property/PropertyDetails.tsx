        ...
        <div className="grid grid-cols-[2fr_1fr] gap-6">
                ...
                {data.image &&
                  data.image.slice(1, 3).map((item, index) => (
                    <div className="relative" key={index}>
                      ...
                      />
                      {index === 1 && (
                        <div className="overlay absolute inset-0 bg-black bg-opacity-50 rounded-lg flex items-center justify-center text-white font-medium text-lg">
                          +10
                        </div>
                      )}
                    </div>
          ...
          <div aria-label="right" className="flex flex-col gap-5">
            ...
            >
              ...
              <div className="my-2 font-semibold">{agent?.properties}</div>
